...
export default function Header() {
  ...
  useEffect(() => {
    if (menuOpen) {
      return; // não exibe o header quando o menu está aberto
    }
  ...
  return (
    <>
      ...
      {/* MENU MOBILE */}
      <nav
        className={`fixed top-0 left-0 w-full h-full z-50 text-white bg-gradient-to-b from-black/95 to-[#101740] backdrop-blur-md transition-transform duration-500 ${
      ...
      >
        ...
        <ul className="flex flex-col mt-6 space-y-2 px-6 lg:hidden">
          <li>
            <Link
              href="/"
